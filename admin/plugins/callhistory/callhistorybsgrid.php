...
<head>
    ...
    <style>
        ...
        .pagination a[title=Suivant], .pagination a[title=Dernier], .pagination a[title=Suivant]:hover, .pagination a[title=Dernier]:hover {
            border-radius: 50%;
            background-color: #eeeeee;

        }

        .pagination a[title=Premier], .pagination a[title=Précédent], .pagination a[title=Premier]:hover, .pagination a[title=Précédent]:hover {
            border-radius: 50%;
            background-color: #eeeeee;
...
<div class='xcontainer-fluid'>
    ...
    $customboton .= "<option value='' ";
    if ($mifilt == '') {
        $customboton .= 'selected';
    };
    $customboton .= ">" . trans('All') . "</option>\n";
    $customboton .= "<option value='answered' ";
    if ($mifilt == 'answered') {
        $customboton .= 'selected';
    };
    $customboton .= ">" . trans('Answered') . "</option>\n";
    $customboton .= "<option value='no answer' ";
    if ($mifilt == 'no answer') {
        $customboton .= 'selected';
    };
    $customboton .= ">" . trans('No answer') . "</option>\n";
    $customboton .= "<option value='busy' ";
    if ($mifilt == 'busy') {
        $customboton .= 'selected';
    };
    $customboton .= ">" . trans('Busy') . "</option>\n";
    $customboton .= "<option value='failed' ";
    if ($mifilt == 'failed') {
        $customboton .= 'selected';
    };
    $customboton .= ">" . trans('Failed') . "</option>\n";
    ...
    $grid->set_search_fields(['src', 'dst', 'calldate', 'clid']);
